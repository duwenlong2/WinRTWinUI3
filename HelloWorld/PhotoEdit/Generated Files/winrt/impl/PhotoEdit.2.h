...
#pragma once
#ifndef WINRT_PhotoEdit_2_H
#define WINRT_PhotoEdit_2_H
#include "winrt/impl/Microsoft.UI.Xaml.1.h"
#include "winrt/impl/Microsoft.UI.Xaml.Markup.1.h"
#include "winrt/impl/PhotoEdit.1.h"
WINRT_EXPORT namespace winrt::PhotoEdit
{
    struct WINRT_IMPL_EMPTY_BASES MainWindow : winrt::PhotoEdit::IMainWindow,
        ...
        impl::require<MainWindow, winrt::Microsoft::UI::Xaml::IWindow, winrt::Microsoft::UI::Xaml::IWindow2>
    {
        ...
        MainWindow(void* ptr, take_ownership_from_abi_t) noexcept : winrt::PhotoEdit::IMainWindow(ptr, take_ownership_from_abi) {}
        MainWindow();
    };
