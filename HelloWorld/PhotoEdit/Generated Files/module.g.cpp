...
void* __stdcall winrt_get_activation_factory([[maybe_unused]] std::wstring_view const& name)
{
    ...
    if (requal(name, L"PhotoEdit.MainWindow"))
    {
        return winrt_make_PhotoEdit_MainWindow();
    }

    if (requal(name, L"PhotoEdit.XamlMetaDataProvider"))
    {
        return winrt_make_PhotoEdit_XamlMetaDataProvider();
    }
