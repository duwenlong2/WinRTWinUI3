...
namespace winrt::PhotoEdit::implementation
{
    ...
    struct WINRT_IMPL_EMPTY_BASES MainWindow_base : implements<D, PhotoEdit::MainWindow, composing, I...>,
        ...
        impl::base<D, winrt::Microsoft::UI::Xaml::Window>
    {
        ...
        using class_type = PhotoEdit::MainWindow;
...
namespace winrt::PhotoEdit::factory_implementation
{
    ...
    {
        using instance_type = PhotoEdit::MainWindow;
